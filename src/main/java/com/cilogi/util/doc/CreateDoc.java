...
/**
 * Create documents from FreeMarker templates. The documents can be text or shop from SVG templates.
...
public class CreateDoc {
     ...
     * @throws java.io.IOException  If FreeMarker can't be configured.
     */
     ...
     * @throws java.io.IOException if the template can't be loaded
     */
     ...
     * @throws java.io.IOException If there are any problems locating or processint the template.
     */
